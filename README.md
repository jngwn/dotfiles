Personal installation, bootstrap, and recovery notes for the maintained Arch
Linux environment.
...
This is an auxiliary note for completing the initial Arch Linux user setup in
WSL. This repository and its setup scripts do not support WSL; do not run the
bootstrap or dotfile deployment scripts there.
