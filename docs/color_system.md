...
| `paper.chromeActive` | `#b8ad94` | Active chrome and borders | Nvim statusline, tmux current window |
...
| `accent.go` | `#006f8a` | Darkened Gopher Blue for readable Go identity | Go source files, Starship |
